...
`zbeyytgilrqruttvecdc`. **Tests:** 238 unit/control tests (`flutter test`).
...
flutter test        # 238 tests — should end "All tests passed!"
```
...
test/              entity · core · control · gateway suites (238 tests)
```
