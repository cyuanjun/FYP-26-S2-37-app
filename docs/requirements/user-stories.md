...
| US37 | ✅ | As a registered premium user, I want to receive personalised AI-assisted fitness plan suggestions based on my profile, activity history, and goals so that the guidance matches my needs. | Live AI plans (gpt-4o-mini, strict schema + validation); Plan Detail #8 with regenerate (Free capped at 1) |
