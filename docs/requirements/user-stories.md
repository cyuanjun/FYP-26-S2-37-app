...
| US18 | ✅ | As a registered free user, I want to receive basic AI progress summaries and basic AI-assisted fitness plan suggestions so that I can better understand my activity data and follow a simple workout routine. | AI summary ✅ + basic AI plan ✅ — both via Edge Functions (stub models); rule skeleton = offline fallback (decided 12 Jun) |
