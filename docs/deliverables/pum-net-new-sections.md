...
> **⚠️ Superseded (13 Jun).** This was the earlier hand-draft (10 core screens). The live PUM is now
> generated by **`scripts/build_pum.py`** — single-source content in
> `../../FYP_docs/Submissions/PUM/PUM-content.md`, built into
> `FYP-26-S2-37-PUM-v1-FILLED.docx` with **19 built-only screens + real embedded screenshots** and a
> "How to use:" step list per screen. Edit `build_pum.py`, not this file. Kept for history.
