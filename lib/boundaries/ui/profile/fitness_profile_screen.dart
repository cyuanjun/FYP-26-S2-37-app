...
class _FitnessProfileScreenState extends ConsumerState<FitnessProfileScreen> {
          ...
          return ListView(
            ...
            children: [
              ...
              SettingRow(
                ...
                onTap: () => _pickNumber('Height (cm)', _heightCm?.toDouble(), 100, 250,
              ...
              SettingRow(
                ...
                onTap: () => _pickNumber('Weight (kg)', _weightKg, 30, 250,
  ...
  Future<void> _pickNumber(
      String title, double? current, double min, double max, void Function(double) onSet) async {
    ...
    final v = await showDialog<double>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              final parsed = double.tryParse(ctl.text.trim());
