...
Built, tested (238 tests), and verified on the Android emulator + iOS simulator against a live
...
flutter test                         # 238 tests, all green
```
...
app/                         everything needed to run the product
  ...
  test/                      238 entity/control/gateway tests
